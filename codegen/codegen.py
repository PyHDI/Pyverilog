...
# codegen.py
#
# Subset code generator from Verilog definitions with Pyverilog
#
...
if __name__ == '__main__':
    ...
    INFO = "Subset code generator from Verilog tree definitions with Pyverilog"
    ...
    codegen = VerilogCodeGenerator(options.topmodule, terms, binddict, resolved_terms, resolved_binddict, constlist)
