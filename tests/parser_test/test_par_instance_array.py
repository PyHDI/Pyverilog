...
Source:  (at 1)
  Description:  (at 1)
    Module: TOP, None (at 1)
      ...
      DeclVars:  (at 3)
        Var:  (at 6)
          Output: LED0, None (at 6)
            Width:  (at 6)
              IntConst: 3 (at 6)
              IntConst: 0 (at 6)
        Var:  (at 6)
          Output: LED1, None (at 6)
            Width:  (at 6)
              IntConst: 3 (at 6)
              IntConst: 0 (at 6)
        Var:  (at 6)
          Output: LED2, None (at 6)
            Width:  (at 6)
              IntConst: 3 (at 6)
              IntConst: 0 (at 6)
        Var:  (at 6)
          Output: LED3, None (at 6)
            Width:  (at 6)
              IntConst: 3 (at 6)
              IntConst: 0 (at 6)
      DeclVars:  (at 3)
        Var:  (at 7)
          Output: LED4, None (at 7)
        Var:  (at 7)
          Output: LED5, None (at 7)
      DeclInstances:  (at 10)
    ...
    Module: SUB, None (at 26)
      DeclParameters:  (at 28)
        Parameter: MODE, None, None (at 28)
          Rvalue:  (at 28)
            IntConst: 0 (at 28)
      DeclVars:  (at 31)
        Var:  (at 31)
          Input: VAL, None (at 31)
      DeclVars:  (at 32)
        Var:  (at 32)
          Output: LED, None (at 32)
      DeclVarAssign:  (at 34)
        Var:  (at 34)
          Wire: outval, None (at 34)
        Assign:  (at 34)
          Var:  (at 34)
            Wire: outval, None (at 34)
          Rvalue:  (at 34)
      ...
      Assign:  (at 35)
        Lvalue:  (at 35)
          Identifier: LED (at 35)
        Rvalue:  (at 35)
          Identifier: outval (at 35)
"""
