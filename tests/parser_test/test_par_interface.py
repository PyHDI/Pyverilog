      ...
      Assign:  (at 24)
        Lvalue:  (at 24)
          Identifier: address (at 24)
            IdentifierScope:  (at 24)
              IdentifierScopeLabel: req_out, None (at 24)
        Rvalue:  (at 24)
          Identifier: address (at 24)
            IdentifierScope:  (at 24)
              IdentifierScopeLabel: req_in, None (at 24)
      Assign:  (at 25)
        Lvalue:  (at 25)
          Identifier: data (at 25)
            IdentifierScope:  (at 25)
              IdentifierScopeLabel: req_out, None (at 25)
        Rvalue:  (at 25)
          Identifier: data (at 25)
            IdentifierScope:  (at 25)
              IdentifierScopeLabel: req_in, None (at 25)
      Assign:  (at 26)
        Lvalue:  (at 26)
          Identifier: valid (at 26)
            IdentifierScope:  (at 26)
              IdentifierScopeLabel: req_out, None (at 26)
        Rvalue:  (at 26)
          Identifier: valid (at 26)
            IdentifierScope:  (at 26)
              IdentifierScopeLabel: req_in, None (at 26)
"""
